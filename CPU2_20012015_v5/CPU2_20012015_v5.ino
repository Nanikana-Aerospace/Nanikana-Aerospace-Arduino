...
***  Otachi Flight COMP Prog. v.20012015-E  ***
...
void setup()
{
  ...
  ss.begin(GPSBaud);
  Serial.println("");
  Serial.println("Otachi Flight COMP Prog. v.20012015-E (v5)");
...
// You must first get a temperature measurement to perform a pressure reading.
  ...
  Serial.print("{TIMEPLOT:DATA2|DATA|SUN|T|");
  Serial.print(voltage); Serial.println("}");
  
  Serial.print("{TIMEPLOT:DATA2|DATA|To|T|");
  ...
  Serial.print("{TIMEPLOT:DATA2|DATA|UV|T|");
  Serial.print(uvIntensity); Serial.println("}");
