...
void setup()
{
  ...
  Serial.println("*");
  smartDelay(500); 
  Serial.println(F("S:MPPI CTRL Mission Computer v13 12 14 A:"));
  smartDelay(2000); // Wait 2 sec before starting
  Serial.println(F("Sx:Nanikana-Aerospace Project Otachi-Arduino 2014-2015"));
    Serial.println(F(""));
...
// Serial RadioLink Begin
  ...
  radioserial.println("CLEARDATA");
  radioserial.println("LABEL, Seq, Run, Lat, Long, AltG, Klmh, Sat, Ttop, Text, Tbot, Hum, AltB, Pwr");
...
//fin du code morse LONGITUDE
   ...
   //radioserial.print("DATA,TIME,"); //Begin of RAW Data
        radioserial.print(sequence);
        radioserial.print(",");
        radioserial.print(time);
        radioserial.print(",");
        ...
        //printInt(gps.satellites.value(), gps.satellites.isValid(), 5);
        //radioserial.print(",");
        radioserial.print(temperature, 2); //display 2 decimal places
        sensors.requestTemperatures();//Jojo
        radioserial.print(",");
        printTemperature(insideThermometer);//Jojo
        radioserial.print(",");
        radioserial.print(DHT.temperature);
        radioserial.print(",");
        radioserial.print(DHT.humidity);
        radioserial.print(",");
        radioserial.print(altitude, 2); //display 2 decimal places
        radioserial.print(",");
        radioserial.print( readVcc(), DEC );
    radioserial.println();
    
  Serial.println();
   
   
   Serial.print("WAIT     : 60 SEC");Serial.println(); 
