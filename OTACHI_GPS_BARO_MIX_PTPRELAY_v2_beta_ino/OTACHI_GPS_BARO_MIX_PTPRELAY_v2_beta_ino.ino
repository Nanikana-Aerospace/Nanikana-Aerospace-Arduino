...
// Defini la pin pour Relay PTP
#define RELAY1  6 
// Defini la pin pour Relay CUTOFF BALLON
#define RELAY2  7
//Define the LED Pin
#define PIN_OUT 9 // MORSE PIN
...
void loop() // run over and over
{
  ...
  Serial.print("Temp: ");
  Serial.print(temperature, 1); //display 1 decimal places
  Serial.println("C");
...
digitalWrite(RELAY1,LOW);           // Turns ON Relays 1 PTP
  ...
  delay(50); //wait a second and get values again.
  ...
  //straltitude = (altitude,2);
   String morseWord = encode ("NANIKANA");
...
void gpsdump(TinyGPS &gps)
{
  ...
  Serial.print("Alt(GPS): "); printFloat(gps.f_altitude()); Serial.print(" Course(GPS):");
    printFloat(gps.f_course()); Serial.println();
  
  Serial.print("Speed: (mps)"); printFloat(gps.f_speed_mps()); Serial.print(" (kmph)");
