...
void setup()
{
  ...
  Serial.begin(9600);
  ss.begin(GPSBaud);
  Serial.println("Otachi Flight COMP Prog. v.20012015-D (Rocket Mod v2)");
  Serial.println("Nanikana-Aerospace aout 2016");
...
// You must first get a temperature measurement to perform a pressure reading.
  ...
  //Serial.print(str);
  Serial.print ("{X-A: ");
  Serial.print (xa-19); Serial.print("}");
  Serial.print("{Y-A: ");
  Serial.print (ya+250); Serial.print("}");
  Serial.print("{Z-A: ");
...
Serial.print ("{X-G: ");
  Serial.print (xg/10); Serial.print("}");
  Serial.print("{Y-G: ");
  Serial.print (yg/10); Serial.print("}");
  Serial.print("{Z-G: ");
  Serial.print (zg/10); Serial.print("}");
...
int xm, ym, zm;
  ...
  Serial.print ("{X-M: ");
  Serial.print (xm-160); Serial.print("}");
  Serial.print("{Y-M: ");
  Serial.print (ym-550); Serial.print("}");
  Serial.print("{Z-M: ");
  Serial.print (zm+210); Serial.print("}");
