/*
Orbitron-WispDDE-Arduino Communication Bridge v1.4 rev B
...
if (satelevation > pitchint && satelevation > 0 && satelevation < 86) { digitalWrite(ledupel, HIGH); digitalWrite(relayup, LOW); Serial.print (""); Serial.print ("8"); }  // up antenna
