/*
Orbitron-WispDDE-Arduino Communication Bridge v1.4 rev D
...
pinMode (potpin1, INPUT_PULLUP); //Set analog pin for input with pullup
...
void loop() {
  ...
  //Serial.println (potval1); //DEBUG MODE
...
headingint = headingDegrees+40; //resultat en int + calibration JF17052015
