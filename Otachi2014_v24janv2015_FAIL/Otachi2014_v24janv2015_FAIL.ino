...
void loop()
{
  ...
  sequence = sequence+1;
  Serial.print("{TIMEPLOT:BARO|DATA|SEQ#|T|");
  Serial.print(sequence); Serial.println("}");
  //Serial.print("{TIMEPLOT:BARO|DATA|RUNTIME|T|");
  ...
  Serial.println("}");
  Serial.print("{TIMEPLOT:BARO|DATA|VACC|T|");
  vaccgps2 = (gps.altitude.meters() - vaccgps1) /7;
  Serial.print (vaccgps2); Serial.println("}");
  Serial.print("{TIMEPLOT:BARO|DATA|ALT-GPS|T|");
  ...
  Serial.println();
  Serial.print("TIMEPLOT:BARO|DATA|SATFIX|T|");
  printInt(gps.satellites.value(), gps.satellites.isValid(), 5);
  Serial.println ("}");
  Serial.print("{TIMEPLOT:BARO|DATA|TEMP-TOP|T|");
  ...
  Serial.print("{TIMEPLOT:BARO|DATA|TEMP-EXT|T|");
  printTemperature(insideThermometer);//Jojo
  Serial.println("}");//line break 
  DHT.read11(dht_dpin);

  Serial.print("{TIMEPLOT:BARO|DATA|TEMP-BOT|T|");
  Serial.print(DHT.temperature);
  Serial.println("}");
  Serial.print("{TIMEPLOT:BARO|DATA|HUM%|T|");
  ...
  Serial.print("{TIMEPLOT:BARO|DATA|ALT-BARO|T|");
