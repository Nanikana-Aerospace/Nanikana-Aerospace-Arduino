...
// ***  MPPI CTRL Mission COMP Prog. v.131214A  ***
...
#define RELAY2  7
// Defini pin pour RX TX RadioLink Serial
#define RXLINK 4
#define TXLINK 5
//Define the LED Pin
...
// The Serial connection to Radio Link 
SoftwareSerial radioserial (RXLINK, TXLINK); //4 Rx  5 TX
...
void setup()
{
  ...
  Serial.println("*");
  smartDelay(500); 
  Serial.println("MPPI CTRL Mission Computer v24 01 15 A");
  smartDelay(2000); // Wait 2 sec before starting
  Serial.println("Nanikana-Aerospace Project Otachi-Arduino 2014-2015");
    Serial.println(F(""));
  ...
  sensors.begin();
// Serial RadioLink Begin
  radioserial.begin(9600);
  radioserial.println("CTRL Mission COMP Status: Initialisation"); //Send status to Telemetry COMP by serial
...
void loop()
{
  ...
  */
  ...
  radioserial.println ("PTT TX   : ON");
  }
  else
  { 
    Serial.println("PTT TX   : WAIT");
    radioserial.println("PTT TX   : STANDBY");
  }  
  {
...
//fin du code morse LONGITUDE
   ...
   //radioserial.print("DATA,TIME,"); //Begin of RAW Data
        radioserial.print ("CTRL Mission COMP SEQ# ");
        radioserial.println(sequence);
        radioserial.print("CTRL TIME: ");
        radioserial.println(time);
        radioserial.print("CTRL TEMP Out: ");
        radioserial.println(temperature, 2); //display 2 decimal places
        sensors.requestTemperatures();//Jojo
        radioserial.print("CTRL Temp TOP");
        printTemperature(insideThermometer);//Jojo
        radioserial.print("CTRL TEMP BOT:");
        radioserial.println(DHT.temperature);
        radioserial.print("CTRL Hum :");
        radioserial.println(DHT.humidity);
        radioserial.print("CTRL ALT: ");
        radioserial.println(altitude, 2); //display 2 decimal places
        radioserial.print("CTRL CPU Vin: ");
        radioserial.println( readVcc(), DEC );
    radioserial.println();
