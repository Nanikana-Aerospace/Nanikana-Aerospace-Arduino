...
// Serial RadioLink Begin
  ...
  radioserial.println("CTRL Mission Comp Status : Boot");
  radioserial.println("");
...
{
  sequence = sequence+1;
  radioserial.println("CTRL Mission Comp Status : Active"); 
  Serial.print("SEQ#     : ");
...
//fin du code morse LONGITUDE
   ...
   //radioserial.print("DATA,TIME,"); //Begin of RAW Data
        radioserial.print("CTRL Mission SEQ# ");
        radioserial.println(sequence);
        //radioserial.print("CTRL Mission Comp ALTB: ");
