/*
Orbitron-WispDDE-Arduino Communication Bridge v1.3c
...
if (satelevation > pitchint && satelevation > 0 && satelevation < 86) { digitalWrite(ledupel, HIGH); Serial.print (""); Serial.print ("8"); }  // up antenna
else { digitalWrite(ledupel, LOW); Serial.print ("1"); }

if (satelevation < pitchint && satelevation > 0) { digitalWrite(leddwel, HIGH); Serial.print (""); Serial.print ("8");}  // down antenna
else { digitalWrite(leddwel, LOW);  Serial.print ("1");}

if (satazimuth > headingint && satelevation > 0) { digitalWrite(ledupaz, HIGH); Serial.print (""); Serial.print ("8");}  // turn left ant
else { digitalWrite(ledupaz, LOW);  Serial.print ("1");}

if (satazimuth < headingint && satelevation > 0) { digitalWrite(leddwaz, HIGH); Serial.print (""); Serial.print ("8");}  // turn right ant
else { digitalWrite(leddwaz, LOW);  Serial.print ("1");}
...
delay(500);
// STOP IF NO NEW SERIAL DATA FROM ORBITRON
if (Serial.available() == 0 ) 
  {
