...
// Ballon stratosphérique avec Arduino Uno R3 et PixHawk + GY80 + Ublox 6 + Relay +DHT11 + DS18B20
...
// Assemblage et programmation par Josianne Gilbert et JF Nadeau ( Nanikana-Aerospace )
...
void setup()
{
  ...
  Serial.println(F("Nanikana-Aerospace Project : Otachi-Arduino 2015"));
    Serial.println(F(""));
...
//fin du code morse LONGITUDE
   ...
   Serial.print("WAIT     : 3 min. before next CW TX");Serial.println(); 
   Serial.println();
  ...
  delay(180000); //wait 3 minutes and get values again.  
}
