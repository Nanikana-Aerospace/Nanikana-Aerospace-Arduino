//Nanikana-Aerospace 2016 LAUNCH CTRL BOX SYSTEM V 1.0
...
//Serial.println (DTMF_Code);// Debug mode
  ...
  //Serial.print (DTMF_count); // Debug mode
   ...
   if (DTMF_digit1 == 6 && DTMF_digit2 == 6 && DTMF_digit3 == 8 && MasterCode == 1 && LaunchMode == 1) 
     {
     delay (1200); 
     digitalWrite (RelayPin8, 0); 
     delay (1500); 
   ...
   if (DTMF_digit1 == 7 && DTMF_digit2 == 7 && DTMF_digit3 == 7 ) 
     ...
     digitalWrite (RelayPin8, 0); 
     delay (1500); 
     Serial.println ("S ROCKET PADS DESACTIVATED");  
     lcd.clear(); 
     lcd.setCursor(0,0); 
   ...
   if (DTMF_digit1 == 8 && DTMF_digit2 == 8 && DTMF_digit3 == 1 && MasterCode == 1) 
     {
     delay (1200); 
     digitalWrite (RelayPin8, 0); 
     delay (1500); 
   ...
   if (DTMF_digit1 == 8 && DTMF_digit2 == 8 && DTMF_digit3 == 2 && MasterCode == 1) 
     ...
     digitalWrite (RelayPin8, 0); 
     delay (1500); 
     Serial.println ("S WARNING. STOP FUELING SEQUENCE"); 
     lcd.clear(); 
     lcd.print("*****STOP*****"); 
     lcd.setCursor(0,1); 
     lcd.print("*****FUELING****"); 
