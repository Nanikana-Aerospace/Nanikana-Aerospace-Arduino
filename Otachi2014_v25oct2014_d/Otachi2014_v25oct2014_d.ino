...
// ***  MPPI CTRL Mission COMP Prog. v.251014D  ***
...
void setup()
{
  ...
  Serial.println("*");
  smartDelay(500); 
  Serial.println(F("MPPI CTRL Mission Comp v.251014D"));
...
//fin du code morse LONGITUDE
  ...
  delay(10000); //wait 10 sec  10
  Serial.print(".");
  delay(10000); //wait 10 sec  20
  Serial.print(".");
  delay(10000); //wait 10 sec  30
  Serial.print(".");
  delay(10000); //wait 10 sec  40
  Serial.print(".");
  delay(10000); //wait 10 sec  50
  Serial.print(".");
  delay(10000); //wait 10 sec  60 
  Serial.print(".");
  delay(10000); //wait 10 sec  70
  Serial.print(".");
  delay(10000); //wait 10 sec  80 
  Serial.print(".");
  delay(10000); //wait 10 sec  90
  Serial.print(".");
  delay(10000); //wait 10 sec 100 
  Serial.print(".");
  delay(10000); //wait 10 sec 110 
  Serial.print(".");
  delay(10000); //wait 10 sec 120  
  Serial.print(".");
  delay(10000); //wait 10 sec 130
  Serial.print(".");
  delay(10000); //wait 10 sec 140 
  Serial.print(".");
  delay(10000); //wait 10 sec 150
  Serial.print(".");
  delay(10000); //wait 10 sec 160
  Serial.print(".");
  delay(10000); //wait 10 sec 170
  Serial.print(".");  
  delay(10000); //wait 10 sec 180
  Serial.println(".");
  Serial.println();
